...
public class PersonTest {
    ...
    public void testEquals() {
        Person person = new Person("Edouard", "Balladur", "test address", "test city", "test zip", "test phone", "test email");
        assertEquals(person, person);

        Person person1 = new Person("John", "Doe", "address", "city", "zip", "phone", "email");
        Person person2 = new Person("John", "Doe", "address", "city", "zip", "phone", "email");
    ...
    public void testHashCode() {
        ...
        Person differentPerson = new Person("Jane", "Doe", "address", "city", "zip", "phone", "email");
